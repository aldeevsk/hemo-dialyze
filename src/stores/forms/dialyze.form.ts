...
//   newForm: IDialyzeForm = dialyzeFormEmpty,
//   newFormOptions: IDialyzeFormOptions = dialyzeFormOptions
// ) {
//   const form = { ...newForm }
...
// export function setDialyzeFormProp<K extends keyof IDialyzeForm>(
//   key: K,
//   newValue: IDialyzeForm[K]
// ): void {
